...
from mpa.network.cellular_debug_dbus import get_all, find_objects_by_interface, send_at, _MM_IFACE, __MM_SIM_IFACE
...
def get_modem_info(modem_index: int) -> ModemInfo | None:
    ...
    if object_path:
        ...
        try:
            ...
            sim = get_all(connection, active_sim_path, __MM_SIM_IFACE)
        except GLib.Error:
            sim = {}
